...
{
    public class GetSubCatDiscountArticleRepository : IGetSubCatDiscountArticleRepository
    {
        public List<DiscountCatArticleVM> GetForSubCatDiscountArticle(long id)
        {
            ...
            using (SqlConnection sqlConn = new SqlConnection(connection))
            {
                ...
                using (SqlCommand sqlComm = new SqlCommand("SP_ForGetSubCatDiscountArticle", sqlConn))
                {
