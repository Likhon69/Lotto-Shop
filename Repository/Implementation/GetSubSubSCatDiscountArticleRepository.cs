...
{
    public class GetSubSubSCatDiscountArticleRepository : IGetSubSubSCatDiscountArticleRepository
    {
        public List<DiscountCatArticleVM> GetForSubSubSCatDiscountArticle(long id)
        {
            ...
            using (SqlConnection sqlConn = new SqlConnection(connection))
            {
                ...
                using (SqlCommand sqlComm = new SqlCommand("SP_ForGetSubSubSCatDiscountArticle", sqlConn))
                {
