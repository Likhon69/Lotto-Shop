...
{
    public class GetShippingAddressListRepository : IGetShippingAddressListRepository
    {
        public List<DefaultAddressVM> GetShippingAddressList(long CustId)
        {
            ...
            using (SqlConnection sqlConn = new SqlConnection(connection))
            {
                ...
                using (SqlCommand sqlComm = new SqlCommand("SP_ShippingAddress_List", sqlConn))
                {
