...
{
    public class GetDefaultBillingAddressRepository : IGetDefaultBillingAddressRepository
    {
        public List<DefaultAddressVM> GetDefaultBillingAddress(long CustId)
        {
            ...
            using (SqlConnection sqlConn = new SqlConnection(connection))
            {
                ...
                using (SqlCommand sqlComm = new SqlCommand("SP_DefaultBilling_Address", sqlConn))
                {
